...
namespace FoodSupplyInvetoryManagementApp.ViewModels.Pages
{
    public class ProductsPageViewModel : ViewModelBase
    {
        ...
        private Provider _eselectedProvider;
        ...
        public Provider SelectedProvider { get => _selectedProvider; set => Set(ref _selectedProvider, value, nameof(SelectedProvider)); }
        ...
        public Provider ESelectedProvider { get => _eselectedProvider; set => Set(ref _eselectedProvider, value, nameof(ESelectedProvider)); }
        public ICollection<Provider> Providers { get => _providers; set => Set(ref _providers, value, nameof(Providers)); }
